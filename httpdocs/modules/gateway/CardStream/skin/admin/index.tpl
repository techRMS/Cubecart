<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
	<div id="CardStream" class="tab_content">
  		...
  		<fieldset><legend>{$LANG.module.cubecart_settings}</legend>
			...
			<div><label for="payment_page_url">{$LANG.cardstream.merchant_passphrase}</label><span><input name="module[merchant_passphrase]" id="merchant_passphrase" class="textbox" type="text" value="{$MODULE.merchant_passphrase}" /></span></div>
